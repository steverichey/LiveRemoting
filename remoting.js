...
JsMain.main = function() {
	...
	JsMain.ctx.addObject("JsMain",JsMain);
	JsMain.cnx = haxe.remoting.ExternalConnection.flashConnect("default","myFlashObject",JsMain.ctx);
}
JsMain.appendDiv = function(Text) {
	JsMain.div = js.Browser.document.createElement("div");
	JsMain.div.innerHTML = Text;
	JsMain.div.className = "Status";
	js.Browser.document.body.appendChild(JsMain.div);
}
JsMain.setText = function(Text) {
	return JsMain.div.innerHTML = Text;
}
var List = function() {
	this.length = 0;
};
